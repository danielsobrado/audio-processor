...
async def test_enhanced_graph_queries():
    ...
    try:
        ...
        for record in entities_result:
            print(
                f"     {record['entity']} ({record['type']}) - confidence: {record['confidence']:.2f}"
            )
...
def print_configuration_help():
    ...
    print("=" * 30)
    print("To enable LLM-based graph processing, set these environment variables:")
    print("")
    ...
    print("")
    print("For OpenAI:")
    print("  export GRAPH_LLM_PROVIDER=openai")
    print("  export GRAPH_LLM_MODEL=gpt-3.5-turbo")
    print("  export OPENAI_API_KEY=your_key_here")
    print("")
    print("For Anthropic:")
    print("  export GRAPH_LLM_PROVIDER=anthropic")
    print("  export GRAPH_LLM_MODEL=claude-3-haiku-20240307")
    print("  export ANTHROPIC_API_KEY=your_key_here")
    print("")
    print("Enable LLM processing methods:")
