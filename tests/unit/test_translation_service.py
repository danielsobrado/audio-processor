...
class TestTranslationService:
    ...
    @pytest.mark.asyncio
    async def test_initialize_model_success(self, mock_torch, mock_get_settings, mock_settings):
    ...
    @patch('app.services.translation.get_settings')
    @pytest.mark.asyncio
    async def test_initialize_model_disabled(self, mock_get_settings, mock_disabled_settings):
    ...
    @patch('app.services.translation.get_settings')
    @pytest.mark.asyncio
    async def test_initialize_model_import_error(self, mock_get_settings, mock_settings):
    ...
    @patch('app.services.translation.get_settings')
    @pytest.mark.asyncio
    async def test_translate_text_success_list_format(self, mock_get_settings, mock_settings):
    ...
    @patch('app.services.translation.get_settings')
    @pytest.mark.asyncio
    async def test_translate_text_success_dict_format(self, mock_get_settings, mock_settings):
    ...
    @patch('app.services.translation.get_settings')
    @pytest.mark.asyncio
    async def test_translate_text_invalid_format(self, mock_get_settings, mock_settings):
    ...
    @patch('app.services.translation.get_settings')
    @pytest.mark.asyncio
    async def test_translate_text_with_source_language(self, mock_get_settings, mock_settings):
