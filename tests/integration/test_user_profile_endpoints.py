...
class TestUserProfileEndpoints:
    ...
    async def test_get_current_user_jit_provisioning(
        self, client, mock_current_user, db_session
    ):
        ...
        with (
            patch(
                "app.api.v1.endpoints.users.get_async_session", return_value=db_session
            ),
            patch(
    ...
    async def test_update_current_user_jit_provisioning(
        self, client, mock_current_user, db_session
    ):
    ...
    async def test_update_current_user_existing_user(
        self, client, mock_current_user, db_session
    ):
    ...
    async def test_list_users_unauthorized(self, client, mock_current_user):
        ...
        with patch(
            "app.api.v1.endpoints.users.require_roles",
    ...
    async def test_crud_fallback_behavior(self, client, mock_current_user):
        ...
        with (
            ...
            patch(
                "app.api.v1.endpoints.users.crud",
