...
def test_llm_factory():
    ...
    try:
        ...
        try:
            ...
            print(f"✅ Relationship extractor factory: {type(relationship_extractor).__name__}")
        except Exception as e:
...
def test_graph_processor_integration():
    ...
    try:
        ...
        if hasattr(processor, 'llm_entity_extractor') and processor.llm_entity_extractor:
        ...
        if hasattr(processor, 'llm_sentiment_analyzer') and processor.llm_sentiment_analyzer:
            print("✅ LLM sentiment analyzer configured")
        else:
            print("⚠️  LLM sentiment analyzer not configured")
        
        if hasattr(processor, 'llm_relationship_extractor') and processor.llm_relationship_extractor:
