    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            existing_user = await crud.user.get_by_email(
                db, email=mock_token_user.email
            )
            ...
            if existing_user:
                ...
                new_user = await crud.user.create_from_token(
    ...
    async with AsyncSessionLocal() as db:
        try:
            ...
            if not db_user:
                ...
                db_user = await crud.user.create_from_token(
                    db, token_data=mock_token_user
                )
            ...
            # Update user profile
            update_data = {"full_name": "Jane Updated Full Name", "is_active": True}
