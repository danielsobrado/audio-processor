...
class EntityNode(GraphNode):
    ...
    def __init__(self, entity_id: str, entity_text: str, 
                 entity_type: str, confidence_score: float):
        super().__init__(
            id=entity_id,
...
class ConversationNode(GraphNode):
    ...
    def __init__(self, conversation_id: str, audio_file_id: str, 
...
class TranscriptSegmentNode(GraphNode):
    ...
    def __init__(self, segment_id: str, conversation_id: str, 
                 text: str, start_time: float, end_time: float, 
                 speaker_id: str, confidence_score: float):
        super().__init__(
            id=segment_id,
...
class SpeaksInRelationship(GraphRelationship):
    ...
    def __init__(self, speaker_id: str, conversation_id: str, 
                 speaking_time: float, turn_count: int):
        super().__init__(
...
class DiscussesRelationship(GraphRelationship):
    ...
    def __init__(self, speaker_id: str, topic_id: str, 
                 mention_count: int, context_relevance: float):
        super().__init__(
            from_node_id=speaker_id,
            to_node_id=topic_id,
...
class MentionsRelationship(GraphRelationship):
    ...
    def __init__(self, segment_id: str, entity_id: str, 
                 mention_position: int, confidence_score: float):
        super().__init__(
...
class FollowsRelationship(GraphRelationship):
    ...
    def __init__(self, from_segment_id: str, to_segment_id: str, 
                 time_gap: float, speaker_change: bool):
        super().__init__(
