...
from app.models.graph import (
    TopicNode, DiscussesRelationship, GraphNode, GraphRelationship
)
...
class TopicGraphService:
    ...
    async def link_speaker_to_topic(self, speaker_id: str, topic_id: str, 
                                  discussion_stats: Dict[str, Any]) -> bool:
    ...
    async def get_trending_topics(self, time_window_hours: int = 24, limit: int = 10) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            evolution_data = {
                ...
                'evolution_stats': {
                    ...
                    'avg_mentions_per_conversation': sum(r['mention_count'] for r in result) / len(result) if result else 0
                }
            }
