...
class ConversationGraphService:
    ...
    async def add_transcript_segments(self, conversation_id: str, segments: List[Dict[str, Any]]) -> int:
    ...
    async def search_conversation_content(self, conversation_id: str, search_term: str) -> List[Dict[str, Any]]:
