...
from app.models.graph import (
    SpeakerNode, SpeaksInRelationship, GraphNode, GraphRelationship
)
...
class SpeakerGraphService:
    ...
    async def link_speaker_to_conversation(self, speaker_id: str, conversation_id: str, 
                                         speaking_stats: Dict[str, Any]) -> bool:
    ...
    async def get_top_speakers(self, limit: int = 10, metric: str = "speaking_time") -> List[Dict[str, Any]]:
    ...
    async def find_similar_speakers(self, speaker_id: str, similarity_threshold: float = 0.7) -> List[Dict[str, Any]]:
